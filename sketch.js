...
function preload(){
  trex_running =   loadImage("1.png","2.png","3.png");
  trex_collided = loadImage("0.png");
  
  groundImage = loadImage("gr.png");
  
  cloudImage = loadImage("clo.png");
  ...
  obstacle6 = loadImage("obs6.png");
  
  gameOverImg = loadImage("ov.png");
